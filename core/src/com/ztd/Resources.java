...
public class Resources {
    ...
    public static Texture coin_pouch = new Texture(Gdx.files.internal("coin_pouch.png"));
    ...
    public static Texture tooltip_bg = new Texture(Gdx.files.internal("ttbg.png"));
    ...
    public static Texture click = new Texture(Gdx.files.internal("click_effect.png"));

    //TODO: Other
    public static Texture saw = new Texture(Gdx.files.internal("saw.png"));

    //TODO: General Indicators
    public static Texture red_bar = new Texture(Gdx.files.internal("red_bar.png"));
    public static Texture green_bar = new Texture(Gdx.files.internal("green_bar.png"));

    //TODO: Zombie Stuff
    public static Texture zombieTexture = new Texture(Gdx.files.internal("Zombies.png"));
    public static Texture greyZombieTexture = new Texture(Gdx.files.internal("DifZombies.png"));
    ...
    public static Texture flappyCannonTexture = new Texture(Gdx.files.internal("EvilFlappyCannon.png"));
    ...
    public static Texture laserBulletTexture = new Texture(Gdx.files.internal("laserBulletTexture.png"));
    ...
    public static Texture laserCannonIcon = new Texture(Gdx.files.internal("laserCannonIcon.png"));
    public static Texture wallIcon = new Texture(Gdx.files.internal("WallIcon.png"));
    public static Texture sawIcon = new Texture(Gdx.files.internal("saw_icon.png"));
    ...
    //Lock & Border
    public static Texture selection = new Texture(Gdx.files.internal("border.png"));
    public static Texture locked = new Texture(Gdx.files.internal("locked.png"));

    //Start & Exit
    public static Texture startbutton = new Texture(Gdx.files.internal("startButton.png"));
    public static Texture exitbutton = new Texture(Gdx.files.internal("exitButton.png"));
